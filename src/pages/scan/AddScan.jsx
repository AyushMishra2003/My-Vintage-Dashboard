...
const AddScan = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response=await addScan(formData);
            if(response?.data){
    ...
    return (
        <div className="p-6 bg-white shadow-md rounded-lg  ">
            <h2 className="text-2xl font-semibold mb-4">Add Scan</h2>
